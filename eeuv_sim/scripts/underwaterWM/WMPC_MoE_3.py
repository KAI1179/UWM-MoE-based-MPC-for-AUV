...
class WMPCController(Node):
    ...
    def __init__(
        ...
        # CEM 参数
        self.declare_parameter('pop_size', 1024)
        self.declare_parameter('elite_frac', 0.25)
        self.declare_parameter('n_iters', 3)
        self.declare_parameter('init_std', 2.0)

        # 代价权重
        self.declare_parameter('w_pos', 10.0)
        self.declare_parameter('w_u', 1e-1)
        self.declare_parameter('w_du', 1e-1)
